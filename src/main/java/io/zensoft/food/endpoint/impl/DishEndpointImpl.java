...
public class DishEndpointImpl implements DishEndpoint {
    ...
    @Autowired
    public DishEndpointImpl(CafeService cafeService, DishService dishService, DishMapper dishMapper) {
    ...
    @Transactional
    @Override
    public DishDto add(@NonNull DishCreateRequestDto request) {
        ...
        Dish dish = dishService.add(dishCreateRequest);
    ...
    @Transactional
    @Override
    public DishDto update(@NonNull Long id, @NonNull DishUpdateRequestDto request) {
        Cafe cafe = cafeService.getById(request.getCafeId());
        ...
        Dish updateDish = dishService.update(dishUpdateRequest);
